    ...
    : BaseResourceProcessor(fileSystem, console, manifestWriter)
{
    ...
    public async Task BuildAndPushProjectContainer(KeyValuePair<string, Resource> resource, ContainerOptions options, bool nonInteractive, string? runtimeIdentifier, bool preferDockerfile, bool verifyImageAge, string? privateRegistryUsername, string? privateRegistryPassword)
    {
        ...
        {
            await containerCompositionService.BuildAndPushContainerForProject(project, containerDetails, options, nonInteractive, runtimeIdentifier, verifyImageAge, privateRegistryUsername, privateRegistryPassword);
        }
