...
public class AzureKeyVaultProcessor(IFileSystem fileSystem, IAnsiConsole console,
...
{
    /// <inheritdoc />
    public override string ResourceType => AspireComponentLiterals.AzureKeyVault;

    /// <inheritdoc />
    public override Resource? Deserialize(ref Utf8JsonReader reader) =>
        JsonSerializer.Deserialize<AzureKeyVaultResource>(ref reader);
