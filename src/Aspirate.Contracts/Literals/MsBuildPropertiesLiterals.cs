...
public static class MsBuildPropertiesLiterals
{
    public const string PublishProfileArgument = "PublishProfile";
    public const string PublishSingleFileArgument = "PublishSingleFile";
    public const string PublishTrimmedArgument = "PublishTrimmed";
    public const string PublishSelfContained = "SelfContained";
